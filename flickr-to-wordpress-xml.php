...
XML;
    ...
    private function processPhoto(array $photo, array $albums): void
    {
        ...
        $postTitle = (!empty($photo['name']) && trim($photo['name']) !== '') ? $photo['name'] : "Photo taken at " . $photo['date_taken'];
...
XML;
    ...
    {
        $attachmentSlug = $this->generateSlug((!empty($photo['name']) && trim($photo['name']) !== '') ? $photo['name'] : 'photo-' . $photo['id']);
